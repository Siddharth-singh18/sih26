/**
 * AYUSYNC MEDICAL TERMINOLOGY SAFETY LAYER (BACKEND)
 * 
 * Medical Safety Rule:
 * Clinical figures, vital signs, units, and dosages (e.g. 120/80 mmHg, 88%, 5mg)
 * are NEVER rewritten or passed to generative LLMs for translation.
 * They are preserved verbatim from the authoritative PostgreSQL database.
 */
...
export const CANONICAL_MEDICAL_TERMS: Record<string, MedicalConditionTemplate> = {
  'SPO2_LOW': {
    ...
    canonicalMeaning: 'Oxygen Saturation below critical physiological threshold (< 90%)',
    ...
    localizedTemplates: {
      ...
      'te-IN': {
        standard: 'మీ శరీరంలో ఆక్సిజన్ స్థాయి తక్కువగా ఉంది. అత్యవసర వైద్య సంరక్షణ అవసరం.',
        simple: 'మీ శరీరంలో ఆక్సిజన్ తక్కువగా ఉంది. వెంటనే వైద్యుడిని సంప్రదించండి.'
      },
      'bn-IN': {
        standard: 'আপনার শরীরে অক্সিজেনের মাত্রা স্বাভাবিকের চেয়ে কম। জরুরি চিকিৎসার প্রয়োজন।',
        simple: 'আপনার রক্তে অক্সিজেন কম। শ্বাসকষ্টের জন্য অবিলম্বে ডাক্তার দেখান।'
      }
    }
  },
  'BP_HIGH': {
    canonicalKey: 'BP_HIGH',
    canonicalMeaning: 'Severe Stage 2 Hypertension / Hypertensive Crisis (Systolic > 180 mmHg)',
  ...
  'FEVER': {
    canonicalKey: 'FEVER',
    canonicalMeaning: 'Pyrexia / Body temperature elevated above 100.4°F (38.0°C)',
  ...
  'URGENT_REFERRAL': {
    ...
    canonicalMeaning: 'Clinical condition exceeds primary facility capabilities; upward specialist transfer mandated',
  ...
  'EMERGENCY': {
    ...
    canonicalMeaning: 'Life-threatening instability; code red priority',
  ...
  'FOLLOWUP_OVERDUE': {
    ...
    canonicalMeaning: 'Scheduled chronic disease or antenatal follow-up elapsed without recorded encounter',
...
/**
 * Formats a medically-safe explanation preserving the exact numerical clinical figure.
 */
